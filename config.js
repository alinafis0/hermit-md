...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'ALI;TOM-BOT;212681951915;https://i.imgur.com/6oRG106.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'ALI-NAFIS;TOM-MD;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'ALI-NAFIS;TOM-MD' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '212681951915',
       DEBUG: DEBUG
};
